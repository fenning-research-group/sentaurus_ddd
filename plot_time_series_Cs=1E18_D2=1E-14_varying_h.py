...
simulation_result_dirs = [
        r'Cs=1E+18D1=4E-16_h=1E-12_D2=1E-14_rho=4E-05_SD=1.0_s=5E+01',
        r'Cs=1E+18D1=4E-16_h=1E-04_D2=1E-14_rho=4E-05_SD=1.0_s=5E+01'
    ]
...
if __name__ == '__main__':
    ...
    plt.tight_layout()
    fig.savefig(os.path.join(results_folder, 'failure_time_0.5MVcm_85C_varying_h.png'), dpi=600)